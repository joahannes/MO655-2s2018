...
TRAFFICS=(2, 4, 6)
algoritmo = "TCP" #MUDAR PARA "TCP" ou "AMBOS"
mobilidade = "est" # MUDAR PARA "mov"
#
...
def plot_delay():
	...
	for traffic in TRAFFICS:
		values = []
		file_input_name = algoritmo + "/summary-" + str(traffic) + "-" + str(mobilidade) + ".txt" #UDP/summary-2-est.txt
	...
	fig.savefig(algoritmo + '/delay' + formato, dpi=200)
